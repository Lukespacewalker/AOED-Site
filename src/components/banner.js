    ...
    return (
        <StaticQuery
            ...
            render={data => (<div className={style.bannerContainer}>
                <div style={{ backgroundColor: `rgb(40, 40, 40)`, height: "100%", width: `100%`, minHeight: "100%", position: "absolute" }}></div>
                <video src={loop} autoPlay={true} muted={true} loop={true} style={{ height: "100%", width: "100%", objectFit: "cover", position: "absolute" }}></video>
